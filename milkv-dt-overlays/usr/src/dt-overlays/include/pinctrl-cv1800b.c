...
static const struct pinctrl_pin_desc cv1800b_pins[] = {
  ...
  PINCTRL_PIN(GP2, "SD1_GPIO1"), // PIN_SD1_GPIO1
  PINCTRL_PIN(GP3, "SD1_GPIO0"), // PIN_SD1_GPIO0
  ...
  PINCTRL_PIN(GP10, "MIPIRX1P"), // PIN_MIPIRX1P
  PINCTRL_PIN(GP11, "MIPIRX0N"), // PIN_MIPIRX0N
  ...
  PINCTRL_PIN(GP16, "SPINOR_MISO"), // PIN_SPINOR_MISO
  PINCTRL_PIN(GP17, "SPINOR_CS_X"), // PIN_SPINOR_CS_X
  PINCTRL_PIN(GP18, "SPINOR_SCK"), // PIN_SPINOR_SCK
  PINCTRL_PIN(GP19, "SPINOR_MOSI"), // PIN_SPINOR_MOSI
  PINCTRL_PIN(GP20, "SPINOR_WP_X"), // PIN_SPINOR_WP_X
  PINCTRL_PIN(GP21, "SPINOR_HOLD_X"), // PIN_SPINOR_HOLD_X
  PINCTRL_PIN(GP22, "PWR_SEQ2"), // PIN_PWR_SEQ2
  PINCTRL_PIN(GP25, "AUD_AOUTR"), // PIN_AUD_AOUTR
