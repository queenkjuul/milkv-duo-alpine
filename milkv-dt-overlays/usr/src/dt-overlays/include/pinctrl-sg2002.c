...
static const struct pinctrl_pin_desc sg2002_pins[] = {
  PINCTRL_PIN(GP0, "IIC0_SCL"), // PIN_IIC0_SCL
  PINCTRL_PIN(GP1, "IIC0_SDA"), // PIN_IIC0_SDA
  PINCTRL_PIN(GP2, "JTAG_CPU_TMS"), // PIN_JTAG_CPU_TMS
  PINCTRL_PIN(GP3, "JTAG_CPU_TCK"), // PIN_JTAG_CPU_TCK
  PINCTRL_PIN(GP4, "SD1_D2"), // PIN_SD1_D2
  PINCTRL_PIN(GP5, "SD1_D1"), // PIN_SD1_D1
  PINCTRL_PIN(GP6, "SD1_CLK"), // PIN_SD1_CLK
  PINCTRL_PIN(GP7, "SD1_CMD"), // PIN_SD1_CMD
  PINCTRL_PIN(GP8, "SD1_D0"), // PIN_SD1_D0
  PINCTRL_PIN(GP9, "SD1_D3"), // PIN_SD1_D3
  PINCTRL_PIN(GP10, "MIPIRX1N"), // PIN_MIPIRX1N
  PINCTRL_PIN(GP11, "MIPIRX1P"), // PIN_MIPIRX1P
  PINCTRL_PIN(GP12, "UART0_TX"), // PIN_UART0_TX
  PINCTRL_PIN(GP13, "UART0_RX"), // PIN_UART0_RX
  PINCTRL_PIN(GP14, "SD0_PWR_EN"), // PIN_SD0_PWR_EN
  PINCTRL_PIN(GP15, "SPK_EN"), // PIN_SPK_EN
  PINCTRL_PIN(GP16, "EMMC_CMD"), // PIN_EMMC_CMD
  PINCTRL_PIN(GP17, "EMMC_DAT1"), // PIN_EMMC_DAT1
  PINCTRL_PIN(GP18, "EMMC_CLK"), // PIN_EMMC_CLK
  PINCTRL_PIN(GP19, "EMMC_DAT0"), // PIN_EMMC_DAT0
  PINCTRL_PIN(GP20, "EMMC_DAT3"), // PIN_EMMC_DAT3
  PINCTRL_PIN(GP21, "EMMC_DAT2"), // PIN_EMMC_DAT2
  PINCTRL_PIN(GP22, "PWR_SEQ2"), // PIN_PWR_SEQ2
  PINCTRL_PIN(GP25, "PWR_GPIO2"), // PIN_PWR_GPIO2
  PINCTRL_PIN(GP26, "ADC1"), // PIN_ADC1
  PINCTRL_PIN(GP27, "USB_VBUS_DET"), // PIN_USB_VBUS_DET
...
static const struct cv1800_pin sg2002_pin_data[ARRAY_SIZE(sg2002_pins)] = {
	...
	CV1800_GENERAL_PIN(GP22, VDDIO_RTC,
			   IO_TYPE_1V8_ONLY,
	...
	CV1800_GENERAL_PIN(GP26, VDD18A_USB_PLL_ETH,
			   IO_TYPE_1V8_ONLY,
			   CV1800_PINCONF_AREA_SYS, 0x0f8, 4,
			   CV1800_PINCONF_AREA_SYS, 0x810),
	CV1800_GENERAL_PIN(GP27, VDD18A_USB_PLL_ETH,
			   IO_TYPE_1V8_ONLY,
	...
	CV1800_GENERAL_PIN(GP10, VDD18A_MIPI,
			   IO_TYPE_1V8_ONLY,
			   CV1800_PINCONF_AREA_SYS, 0x184, 7,
			   CV1800_PINCONF_AREA_SYS, 0xc50),
	CV1800_GENERAL_PIN(GP11, VDD18A_MIPI,
			   IO_TYPE_1V8_ONLY,
