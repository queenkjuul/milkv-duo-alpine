...
- `*.patch`: patch files to apply to `duo-buildroot-sdk-v2` before running `build_fsbl` (apply with `git am <patch>`; see Milk-V buildroot "step by step compilation" instructions for how to run `build_fsbl` for `milkv_duo_s_musl_sd`)
